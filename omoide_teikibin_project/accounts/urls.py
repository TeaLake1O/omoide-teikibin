...
=======
        ...
        name='login'),
>>>>>>> 7f709a23cecbaccfc1c5aed7a5c836b3a3f50d92
    ...
    path('api/me/change',views.ChangeUserInfAPIView.as_view(), name = 'api_change'),
    path('api/me/detail',views.UserInfAPIView.as_view(), name = 'api_detail_user_inf'),
