...
class Post(models.Model):
    ...
    username = models.ForeignKey(CustomUser,blank=True, null=True, on_delete = models.CASCADE, verbose_name="投稿者")
    ...
    def __str__(self):
        return f"投稿者:{self.username.username}" "投稿ID:{self.post_id}"